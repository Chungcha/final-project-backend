...
class RestaurantsController < ApplicationController
    ...
    def self.generate(cuisine)
        ...
        serialized_data = ActiveModelSerializers::Adapter::Json.new(ChatroomSerializer.new(chatroom)).serializable_hash
        ActionCable.server.broadcast "ChatRoom-#{chatroom.id}", serialized_data
